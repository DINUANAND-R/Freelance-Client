    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-extrabold text-blue-700">FreelanceHub</h1>
            <p className="text-sm text-gray-600">
              Logged in as <span className="text-blue-600 font-medium">{name}</span>
            </p>
            ...
            <div key={client._id} className="w-80 bg-white shadow-md rounded-xl overflow-hidden p-4">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="bg-blue-800 text-white w-full py-2 rounded-lg hover:bg-blue-600 transition font-semibold"
                >
                  Connect
                </button>
              </div>
      ...
      <footer className="bg-blue-400 text-white mt-12">
        ...
        <div className="text-center py-4 border-t border-blue-500 text-sm">
