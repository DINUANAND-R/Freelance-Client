...
export default function ClientsList() {
    ...
    const handleConnect = (client) => {
        console.log(`Connecting to client: ${client.email}`);
        navigate('/chat', {
            state: {
    ...
    const handleConfirmBlock = async () => {
        ...
        try {
            await axios.delete(`http://localhost:9000/api/client/delete/${clientToBlock.email}`);
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-950 text-indigo-100 font-inter">
            ...
            <main className="flex-grow max-w-7xl mx-auto px-6 py-12 w-full">
                <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center text-indigo-300">Registered Clients</h1>

                {clients.length === 0 ? (
                    <div className="text-center text-gray-500 text-lg mt-10">No clients found.</div>
                ) : (
                    <motion.div
                        ...
                        <AnimatePresence>
                            {clients.map((client) => (
                                ...
                                >
                                    ...
                                    <h2 className="text-2xl font-bold text-indigo-200 mb-2">{client.name}</h2>
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-gray-400 mb-6">
                                Are you sure you want to block <strong>{clientToBlock?.name}</strong>?
                            ...
                            <div className="flex flex-col gap-4">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <CheckCircle size={18} className="inline mr-2" /> Block Client
                                </motion.button>
                                <motion.button
