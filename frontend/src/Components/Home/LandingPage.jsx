...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen font-inter antialiased bg-gray-50 text-slate-800">
            ...
            <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
                <nav className="flex items-center justify-between px-4 sm:px-6 py-4 md:px-12">
                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 transition-colors duration-300">
                        Freelance<span className="text-yellow-500">Connect</span>
                    </h1>

                    <div className="hidden md:flex items-center space-x-8">
                        <a href="#features" className="text-slate-600 hover:text-yellow-500 font-medium text-lg transition-colors duration-200">Features</a>
                        <a href="/about" className="text-slate-600 hover:text-yellow-500 font-medium text-lg transition-colors duration-200">About</a>
                        <a href="/contact" className="text-slate-600 hover:text-yellow-500 font-medium text-lg transition-colors duration-200">Contact</a>
                    </div>
                    <Link to={'/role'}>
                        <button
                            className="bg-yellow-500 text-slate-900 font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-yellow-600 transition-transform duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base"
                        >
                            Get Started
                        </button>
                    </Link>
            ...
            {/* Hero Section */}
            <section className="relative flex flex-col md:flex-row items-center justify-between px-4 sm:px-8 md:px-16 py-16 md:py-32 bg-gray-900 text-white overflow-hidden">
                {/* Abstract background shapes */}
                <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-yellow-400 opacity-10 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3 animate-fade-in"></div>
                ...
                <div className="relative z-10 md:w-1/2 text-center md:text-left space-y-4 md:space-y-8 mt-8 md:mt-0 animate-fade-in">
                    <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
                        Connect with <span className="text-yellow-500">Top Freelancers</span> Worldwide
                    </h2>
                    <p className="text-base sm:text-lg md:text-xl max-w-xl mx-auto md:mx-0 text-gray-300">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <Link to="/role">
                            <button
                                className="bg-yellow-500 text-slate-900 font-bold px-6 py-3 md:px-8 md:py-4 rounded-md hover:bg-yellow-600 transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl text-base"
                            >
                                Start Your Journey →
                            </button>
                        </Link>
                ...
                <div className="relative md:w-1/2 flex justify-center items-center mt-12 md:mt-0 animate-fade-in-delay-2">
                    {/* Using a placeholder for an image to ensure the code is self-contained and runnable */}
                    <img
                        src="https://placehold.co/800x600/ffc107/022c4f?text=FreelanceConnect"
            ...
            {/* Features Section */}
            <section id="features" className="px-4 sm:px-6 md:px-20 py-16 md:py-20 bg-gray-50">
                <div className="text-center mb-12 md:mb-16">
                    <span className="text-yellow-500 font-semibold uppercase tracking-widest text-sm">Our Advantages</span>
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mt-2">
                        Why Choose <span className="text-yellow-500">FreelanceConnect</span>?
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
                    {features.map((item, index) => (
                        <div
                            key={index}
                            className="p-6 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group cursor-pointer border-t-4 border-yellow-500 animate-card-fade-in"
                            style={{ animationDelay: `${index * 0.1}s` }}
                        >
                            <div className="w-14 h-14 md:w-16 md:h-16 bg-yellow-100 rounded-full flex items-center justify-center mb-4 transition-colors duration-300 group-hover:bg-yellow-200">
                                {item.icon}
                            </div>
            ...
            <section className="bg-gray-900 text-white px-4 sm:px-8 md:px-20 py-16 md:py-20 text-center animate-fade-in">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">Ready to get started?</h2>
                ...
                <Link to="/role">
                    <button
                        ...
                        className="bg-yellow-500 text-gray-900 font-bold px-8 py-3 md:px-10 md:py-4 rounded-full shadow-lg hover:bg-yellow-600 transition-transform duration-300 transform hover:scale-105 text-base"
                    >
            ...
            {/* Footer */}
            <footer className="bg-gray-800 text-gray-300 px-4 sm:px-8 md:px-20 py-12">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 flex-1">
                        <div>
                            ...
                            <ul className="space-y-1 text-sm">
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">About</a></li>
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Contact</a></li>
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Community</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-1 text-sm">
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Hire Talent</a></li>
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Post a Job</a></li>
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Find Freelancers</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-1 text-sm">
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Help Center</a></li>
                                <li><a href="#" className="hover:text-yellow-500 transition-colors duration-200">Terms of Use</a></li>
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4 text-xl mt-1">
                                <a href="#" className="hover:text-yellow-500 transition-colors duration-200" aria-label="Social Media Link"><LucideGlobe /></a>
                                <a href="#" className="hover:text-yellow-500 transition-colors duration-200" aria-label="Social Media Link"><LucideTwitter /></a>
                                <a href="#" className="hover:text-yellow-500 transition-colors duration-200" aria-label="Social Media Link"><LucideFacebook /></a>
                                <a href="#" className="hover:text-yellow-500 transition-colors duration-200" aria-label="Social Media Link"><LucideInstagram /></a>
                            </div>
                        </div>
                    </div>
                </div>
