    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 text-gray-800">
            ...
            <section className="text-center py-14">
                ...
                <Link
                    to="/signup"
                    className="bg-blue-700 hover:bg-blue-800 text-white text-lg font-semibold py-3 px-6 rounded-full 
            ...
            <section className="px-8 py-10 bg-white shadow-inner">
                <h3 className="text-3xl font-semibold mb-4 text-center text-blue-800">Why We Built Freelance Connect</h3>
            ...
            <section className="py-12 px-8 bg-blue-100">
                <h3 className="text-3xl font-semibold text-center mb-8 text-blue-900">How It Helps</h3>
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 text-lg">
                    <div 
                        className="bg-white p-6 rounded-xl shadow-md transform transition-transform 
                        duration-300 hover:scale-105"
                    >
                        <h4 className="text-xl font-bold text-blue-800 mb-2">For Freelancers</h4>
                    ...
                    <div 
                        ...
                        duration-300 hover:scale-105"
                    >
                        <h4 className="text-xl font-bold text-blue-800 mb-2">For Clients</h4>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
